...
<head>
    ...
    <link href="{{ asset('ui/frontend/assets') }}/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('ui/frontend/assets') }}/plugins/custom/vis-timeline/vis-timeline.bundle.css" rel="stylesheet"
        type="text/css" />
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled">
    ...
    <!--begin::Javascript-->
    <script>
        var hostUrl = "{{ asset('ui/frontend/assets') }}/";
    </script>
