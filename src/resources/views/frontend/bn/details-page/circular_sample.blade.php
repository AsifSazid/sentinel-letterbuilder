    ...
    <div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 opacity-75 fw-bold my-1 text-bangla fs-2x"><a href="{{route('bn.home')}}" class="text-gray-900">{{__('হোম')}}</a> <a href="{{route('bn.multipleTemplate')}}" class="text-gray-900"> &nbsp;{{__('/ সমস্ত টেমপ্লেট ')}} </a> &nbsp;{{__('/ পরিপত্রের নমুনা ')}}</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
        </div>
            ...
            <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                ...
                <div class="col-xl-8">
                    ...
                    <div class="row pb-lg-8 pb-4">
                        ...
                        style="background-color:#020202;background-image:url('{{ asset('ui/frontend/assets') }}/media/forms/circular-sample.png">
                        <!--begin::Body-->
                        <div class="card-body d-flex justify-content-between flex-column ps-xl-18">
                            <!--begin::Heading-->
                            <span class="text-white text-bangla fs-2x mb-5">{{__('পরিপত্রের নমুনা')}}</span>
                                <!--begin::Action-->
                                ...
                                <div class="card-header border-0 pt-5">
                                    ...
                                    {{-- <div class="card-toolbar">
                                        <a href="#" class="btn btn-sm btn-light text-bangla">
                                            {{__('View All Technology')}}সমস্ত টেকনোলজি দেখুন
                                        </a>
                                    </div> --}}
                                    <!--end::Toolbar-->
                                </div>
