                ...
                <div class="col-xl-8">
                    ...
                    <div class="row pb-lg-8 pb-4">
                        <div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-500px"
                            style="background-image:url('{{ asset('ui/frontend/assets') }}/media/forms/semi-govt-letter-sample.png">
                            <!--begin::Body-->
                            <div class="card-body d-flex justify-content-between flex-column ps-xl-18" >
                                <!--begin::Heading-->
                                <h3 class="fw-bold text-gray-800 fs-2x mb-5 ms-n1">Semi Govt Letter Sample</h3>
                                <!--end::Heading-->
