...
<html lang="en">
    <head>
        ...
        <title>Office Order Sample</title>
    ...
    <body style="background-color: gainsboro; display: flex; justify-content: center;">
        <div style="background-color: white; width: 8.3in; height: 11.7in;">
            <table>
                <tr>
                    <td style="width: 5%;"></td>
                    <td style="width: auto; text-align: center;">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <span style="width: 1px; white-space: nowrap;">অবগতি ও প্রয়োজনীয় (প্রযোজ্য ক্ষেত্রে) ব্যবস্থা গ্রহণের জন্য অনুলিপি প্রেরণ করা হইল: </span>
                                </td>
                            </tr>
                        </table>
                        <table>
