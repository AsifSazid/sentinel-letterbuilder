    ...
    <div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-gray-900 opacity-75 fw-bold my-1 text-bangla fs-2x"><a href="{{route('bn.home')}}" class="text-gray-900">{{__('হোম')}}</a> <a href="{{route('bn.multipleTemplate')}}" class="text-gray-900"> &nbsp;{{__('/ সকল টেমপ্লেট ')}} </a> &nbsp;{{__('/ নোটিশ ')}}</h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
        </div>
                        ...
                        <div class="card-body d-flex justify-content-between flex-column ps-xl-18">
                            ...
                            <span class="text-white text-bangla fs-2x mb-5">{{__('নোটিশ')}}</span>
                                ...
                                <div class="mb-xl-10 mb-3">
                                    ...
                                    <a href="{{route('bn.web.preview', $docId = 1)}}"
