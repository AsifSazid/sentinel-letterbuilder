                ...
                <div class="col-xl-8">
                    ...
                    <div class="row pb-lg-8 pb-4">
                        <div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-500px"
                            style="background-image:url('{{ asset('ui/frontend/assets') }}/media/forms/notification-sample.png">
                            <!--begin::Body-->
                            <div class="card-body d-flex justify-content-between flex-column ps-xl-18">
                                <!--begin::Heading-->
                                <span class="text-gray-800 text-bangla fs-2x mb-5">{{ __('প্রজ্ঞাপনের নমুনা') }}</span>
                                <!--end::Heading-->
