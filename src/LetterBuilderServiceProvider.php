...
class LetterBuilderServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        Blade::component('pdf-textCenter', \Sentinel\Letterbuilder\App\View\Components\Pdfs\PdfTextCenter::class);
        Blade::component('pdf-textAndBorderBottom', \Sentinel\Letterbuilder\App\View\Components\Pdfs\PdfTextAndBorderBottom::class);
        Blade::component('pdf-borderBottomAndText', \Sentinel\Letterbuilder\App\View\Components\Pdfs\PdfBorderBottomAndText::class);
        Blade::component('pdf-annotation', \Sentinel\Letterbuilder\App\View\Components\Pdfs\PdfAnnotation::class);
    }
